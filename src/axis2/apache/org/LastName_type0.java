...
public class LastName_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  public static class Factory {
     ...
     */
    public static LastName_type0 parse(javax.xml.stream.XMLStreamReader reader)
    ...
    if (serializeType) {
      ...
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
            "type", namespacePrefix + ":lastName_type0", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
  ...
  public void setLastName_type0(java.lang.String param) {
    ...
    if (org.apache.axis2.databinding.utils.ConverterUtil.convertToString(param)
      ...
      HelloWorldService1MessageReceiverInOut.message = "LastName_type0 LastName format non conforme";

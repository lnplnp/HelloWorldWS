 ...
 */
        ...
        */
        ...
        public class HelloWorldService1MessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("direBonjour".equals(methodName)){
                ...
                fr.manuelpayet.www.helloworldws.DireBonjourResponse direBonjourResponse5 = null;
	                        fr.manuelpayet.www.helloworldws.DireBonjourRequest wrappedParam =
                                                             (fr.manuelpayet.www.helloworldws.DireBonjourRequest)fromOM(
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), direBonjourResponse5, false, new javax.xml.namespace.QName("http://www.manuelpayet.fr/helloworldws/",
                                                    "direBonjour"));
        ...
        newMsgContext.setEnvelope(envelope);
            ...
            msgContext.setProperty(org.apache.axis2.Constants.FAULT_NAME,"direBonjourFault");
        ...
        //
            ...
            throws org.apache.axis2.AxisFault {
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, fr.manuelpayet.www.helloworldws.DireBonjourResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(fr.manuelpayet.www.helloworldws.DireBonjourResponse.MY_QNAME,factory));

 ...
 */
     ...
     */
    public class HelloWorldService1Skeleton implements HelloWorldService1SkeletonInterface{
         ...
         */
            ...
            throws DireBonjourFaultException{
                ...
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#direBonjour");
        }

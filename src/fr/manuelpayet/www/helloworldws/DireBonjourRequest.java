 ...
 */
        ...
        public  class DireBonjourRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":direBonjourRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "direBonjourRequest",
                           xmlWriter);
                                           ...
                                           localFirstName.serialize(new javax.xml.namespace.QName("","firstName"),
                                            ...
                                            if (localBirthYear==null){
                                                 throw new org.apache.axis2.databinding.ADBException("birthYear cannot be null!!");
                                            }
    ...
    public static class Factory{
        ...
        */
        public static DireBonjourRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DireBonjourRequest object =
                new DireBonjourRequest();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"direBonjourRequest".equals(type)){
                                ...
                                return (DireBonjourRequest)fr.manuelpayet.www.helloworldws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","lastName").equals(reader.getName())){
                                                ...
                                                object.setLastName(fr.manuelpayet.www.helloworldws.LastName_type1.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","firstName").equals(reader.getName())){
                                                ...
                                                object.setFirstName(fr.manuelpayet.www.helloworldws.FirstName_type1.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","birthYear").equals(reader.getName())){
                                
                                                object.setBirthYear(fr.manuelpayet.www.helloworldws.BirthYear_type1.Factory.parse(reader));

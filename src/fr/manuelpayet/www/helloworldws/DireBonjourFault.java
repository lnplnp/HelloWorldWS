...
/**
 * DireBonjourFault bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DireBonjourFault implements org.apache.axis2.databinding.ADBBean {
  ...
  public static class Factory {
     ...
     */
    public static DireBonjourFault parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      DireBonjourFault object = new DireBonjourFault();
      ...
      try {
        ...
        if (reader.getAttributeValue(
          ...
          if (fullTypeName != null) {
            ...
            if (!"direBonjourFault".equals(type)) {
              // find namespace for the prefix
              java.lang.String nsUri = reader.getNamespaceContext()
                  .getNamespaceURI(nsPrefix);
              return (DireBonjourFault) fr.manuelpayet.www.helloworldws.ExtensionMapper
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("", "code").equals(reader
                    .getName())) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("", "message").equals(reader
                    .getName())) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("", "details").equals(reader
                    .getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "details" + "  cannot be null");
              }
  ...
  public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
      "http://www.manuelpayet.fr/helloworldws/", "direBonjourFault", "ns1");
    ...
    if (serializeType) {
      ...
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
            "type", namespacePrefix + ":direBonjourFault", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
            "type", "direBonjourFault", xmlWriter);
      }

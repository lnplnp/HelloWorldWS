 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":direBonjourFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "direBonjourFault",
    ...
    public static class Factory{
        ...
        */
        public static DireBonjourFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DireBonjourFault object =
                new DireBonjourFault();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"direBonjourFault".equals(type)){
                                ...
                                return (DireBonjourFault)fr.manuelpayet.www.helloworldws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
